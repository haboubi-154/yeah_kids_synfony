...
/* user/edit.html.twig */
class __TwigTemplate_297416290ddc8d96088fd1877969ddb706195fc865a50efe57a80725f8c68659 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_index", ["role" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 10, $this->source); })()), "role", [], "any", false, false, false, 10)]), "html", null, true);
        echo "\">back to list</a>
...
{% endblock %}
", "user/edit.html.twig", "C:\\Users\\fedi\\fadi\\templates\\user\\edit.html.twig");
    }
}
